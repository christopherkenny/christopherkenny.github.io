...
## Selected short courses and workshops

### Agentic AI for Political Science Research

Princeton University, Center for the Study of Democratic Politics, **Fall 2026**.

An introduction to using agentic AI tools responsibly to support political science research.
Slides are [available here](https://christophertkenny.com/files/2026-09-10-csdp-ai.pdf) and a demo LLM Wiki is [available here](https://github.com/christopherkenny/csdp-llm-wiki) sans article PDFs.

<details>
<summary>Full Workshop Description</summary>

This workshop introduces effective uses of agentic AI for political science research. Tools like Claude Code and Codex work directly inside a project: running code, executing analyses, and iterating on results. Chris will explain how to customize it with AGENTS.md files and reusable skills. This allows an agent to use a project's conventions and domain knowledge, so it applies the right methods without being re-taught every session. Chris will demonstrate agent-assisted data analysis and simulation workflows, with a short demonstration of using a knowledge graph from relevant literature to support reviewing a draft.

</details>


### R Bootcamp for Social Scientists

Princeton University, **Fall 2026**.

Instructor with Eric Manning.

An introductory bootcamp to R for new PhD students across the social sciences, introducing R, the tidyverse, Quarto, and Git/GitHub. Materials for the bootcamp are [available via Princeton DDSS](https://princeton-ddss.github.io/r-bootcamp/).

<details>
<summary>Full Bootcamp Description</summary>
...
### AI in RStudio Without Copy-Paste

Princeton University, **Spring 2026**.

<details>
<summary>Full Workshop Description</summary>
This hybrid workshop introduces Posit Assistant, a newly-released service that embeds an AI agent (via Anthropic) directly into RStudio. Posit Assistant has live access to your R session (packages, environment variables, and actual data structures), making its suggestions more accurate and contextually relevant than other isolated agent tools.

We will:

1. discuss the Assistant's security features, pricing, installation, and setup;
2. compare the Assistant to existing coding agent tools and plugins; and
3. help you leave the workshop with a configured Assistant in your local RStudio
</details>
