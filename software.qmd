...
tb <- tribble(
  ...
  'feltr', 'feltr: Access the Felt API', 'CRAN', 'https://christophertkenny.com/feltr',
  ...
  'bskyr', 'bskyr: Interact with Bluesky Social', 'GitHub', 'https://christophertkenny.com/bskyr/'
) %>% 
  mutate(
