...
(with Cory McCartan, Tyler Simko, Emma Ebowe, Michael Y. Zhao, and Kosuke Imai). 2024. PNAS.

```{r, echo = FALSE, results='asis'}
make_button(c('First paragraph', 'BibTeX'),  c('mccartan2024reformsAbs', 'mccartan2024reformsBib'))
```
