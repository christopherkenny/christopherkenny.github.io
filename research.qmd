...
```{=html}
<p>
<button class="btn btn-outline-primary" type="button" data-bs-toggle="collapse" data-bs-target="#fifield2020essentialAbs" aria-expanded="false" aria-controls="collapseExample">
    Abstract
  </button>
<button class="btn btn-outline-primary" type="button" data-bs-toggle="collapse" data-bs-target="#fifield2020essentialBib" aria-expanded="false" aria-controls="collapseExample">
    BibTeX
  </button>
</p>
```

<div class="collapse" id="fifield2020essentialBib">
...
<div class="collapse" id="fifield2020essentialAbs">
  <div class="card card-body">
