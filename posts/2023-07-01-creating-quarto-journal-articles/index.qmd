...
Quarto has a list of [templates](https://quarto.org/docs/extensions/listing-journals.html), as does [Awesome Quarto](https://github.com/mcanouil/awesome-quarto#journals).
...
As such, I just named it for the template and added text to make it clear what journals it was for.
...
(If you now feeling anxious about the name, this is the right time to fix it before doing anything.) 
Then, I remove the (now complete) TODOs for those.
